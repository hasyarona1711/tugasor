...
$namastand = query("SELECT * FROM marketing WHERE nama_marketing = '$nama'")[0];

if(isset($_POST["submit"]))
{
	if(tambahmarketingstand($_POST) > 0)
	{
		echo 
		"
			<script> alert ('Pemilihan Stand Berhasil, Silahkan Hubungi EO yang Bersangkutan!');
			</script>
		";
	}
	else
...
<form action="" method="post">
	...
	<tr>
			<td><label>Nama Stand yang Dipilih : </label></td>
			<td><input type="text" name="namastand" value="<?php echo $namastand["nama_marketing"]; ?>"></td>
	</tr>
	<tr>
