...
$stand = query("SELECT * FROM event WHERE nama_event = '$nama'")[0];


$infostand = query("SELECT * FROM marketing WHERE nama_event = '$nama'");
...
<center>
<img src="img/<?php echo $stand["stand_event"]; ?>" width="50%">
<img src="img/<?php echo $stand["layout_event"]; ?>" width="50%">
</center>
	...
	<table border="1" cellpadding="10" cellspacing="0" class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		...
		<tr>
			...
			<td><a href="detailstand.php?nama=<?php echo $info["nama_marketing"]; ?>"><?php echo $info["nama_marketing"]; ?></a></td>
			<td><?php echo $info["harga_marketing"]; ?></td>
			<td><button class="button is-primary"><a href="hapusstand.php?nama=<?php echo $info["nama_marketing"]; ?>">Hapus</a></button></td>
		</tr>
		<?php }; ?>
	</table>	
<button><a href="tambahstand.php">Tambah Info Stand</a></button>
</body>
</html>