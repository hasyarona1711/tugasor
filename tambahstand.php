...
{
	//cek apakah data stand berhasil ditambahkan atau tidak
...
<center>
<div class="tambahstand">
	<form action="" method="post">

	<ul>
		<li>
			<label for="namaevent">Nama Event</label>
			<input type="text" name="namaevent" id="namaevent" autocomplete="off">
		</li>
		<li>
		...
		<li>
			<label for="harga">Harga Stand</label>
